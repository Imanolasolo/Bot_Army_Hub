...
def main():
    ...
    st.set_page_config(page_title="BOTARMY_HUB AI", page_icon=":smartphone:")
    ...
    with st.sidebar:
        ...
        with st.expander("Expand questions"):
            ...
            instrucciones = [
                "1. What is BOTARMY-HUB?.",
                "2. Speak about BOTARMY-HUB´s services.",
                "3. Give me a brief explanation about projects of BOTARMY-HUB.",
                "4. How can I contact with BOTARMY_HUB?"
            ]
