...
# Subtítulo
st.subheader('Welcome to the future of automation with AI powered virtual assistants')
...
# Página "Sobre Nosotros"
    ...
    code_message ="""    
    Our mission: provide clients with the tools to thrive in the digital landscape. 
    Join us on this journey of innovation, and let's build the future together with BOTARMY-HUB."""
...
# Página de Contacto
    ...
    with col1:
        ...
        st.markdown('<a href="mailto:jjusturi@gmail.com">Send us a mail</a>', unsafe_allow_html=True)
...
if opcion == 'Chat with us':
    ...
    with col1:
        st.image('bot_icon.png',width=100)
    with col2:
